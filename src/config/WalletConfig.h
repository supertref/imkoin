...
namespace WalletConfig
{
    ...
    const std::string_view addressPrefix = "ik";

    /* Your coins 'Ticker', e.g. Monero = XMR, Bitcoin = BTC */
    const std::string ticker = "IMKO";
    ...
    const std::string daemonName = "imkoind";
    ...
    const std::string contactLink = "http://www.heuning.nl/contact";
