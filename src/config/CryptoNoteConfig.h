...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 21625;
...
const char     P2P_STAT_TRUSTED_PUB_KEY[]                    = "joostisandersgeaard2019";
...
const char     LATEST_VERSION_URL[]                          = "http://latest.heuning.nl";
const std::string LICENSE_URL                                = "https://github.com/supertref/imkoin/blob/master/LICENSE";
const static   boost::uuids::uuid CRYPTONOTE_NETWORK         =
{
    {  0xd1, 0x55, 0x55, 0xd7, 0x14, 0xfb, 0xe, 0xe, 0xe3, 0x31, 0x43, 0x14, 0x25, 0x2, 0x43, 0x2A  }
};

const char* const SEED_NODES[] = {
  "13.81.27.250:11897" //rock
};
} // CryptoNote
